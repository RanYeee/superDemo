...
//lazy loading
- (void)badgeInit:(BOOL)isRedDotBadge
{
    ...
    if (nil == self.badge) {
        ...
        CGRect frm =CGRectMake(0,0,0,0);
        if (isRedDotBadge)
        {
            frm = CGRectMake(0, -redotWidth, redotWidth, redotWidth);
        }else
        {
            frm = CGRectMake(CGRectGetWidth(self.frame), -redotWidth, redotWidth, redotWidth);
        }
        ...
        if (isRedDotBadge)
        {
            self.badge.center = CGPointMake(0 + 2 + self.badgeCenterOffset.x, self.badgeCenterOffset.y);
        }else
        {
            self.badge.center = CGPointMake(CGRectGetWidth(self.frame) + 2 + self.badgeCenterOffset.x, self.badgeCenterOffset.y);
        }
